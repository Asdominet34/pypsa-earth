...
def calculate_scale(gegis_load, file_path_temba):
    ...
    # Seleziona la colonna 'Country' e la colonna 2050
    demand_temba = df_temba[['Country', '2050']]

    # Trasforma i dati di '2050' da Pj/anno a MWh/anno (1 Pj = 277.78 GWh = 277780 MWh)
    demand_temba['2050_MWh'] = demand_temba['2050'] * 277780
    ...
    merged_df['scale_country'] = merged_df['2050_MWh'] / merged_df['Electricity demand']
